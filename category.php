        ...
        <div class="mr-2 ml-2">
            ...
            <div class="row mt-3">
                <div class="col-sm-6 mb-2">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellendus perspiciatis at et minima
                        placeat ducimus in, eveniet blanditiis maxime nisi nam fuga dolor molestias quo tempore
                        praesentium laudantium aspernatur odit, voluptatibus reprehenderit qui sint inventore! Cumque
                        voluptatibus consectetur soluta perspiciatis!</p>
                    <a href="./nature.php"><button class="btn btn-secondary btn-sm btn-outline-dark"
                ...
                <div class="col-sm-6 ">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellendus perspiciatis at et minima
                        ...
                        praesentium laudantium aspernatur odit, voluptatibus reprehenderit qui sint inventore! Cumque
                        voluptatibus consectetur soluta perspiciatis!</p>
                    <a href="./landscape.php"><button class="btn btn-secondary btn-sm btn-outline-dark"
                            type="button">Show More
                        </button></a>
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-sm-6 mb-2">
                    <h4>Animals Photography</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellendus perspiciatis at et minima
                        placeat ducimus in, eveniet blanditiis maxime nisi nam fuga dolor molestias quo tempore
                        praesentium laudantium aspernatur odit, voluptatibus reprehenderit qui sint inventore! Cumque
                        voluptatibus consectetur soluta perspiciatis!</p>
                    <a href="./animal.php"><button class="btn btn-secondary btn-sm btn-outline-dark"
                            type="button">Show More
                        </button></a>
                </div>
                <div class="col-sm-6">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellendus perspiciatis at et minima
                        ...
                        praesentium laudantium aspernatur odit, voluptatibus reprehenderit qui sint inventore! Cumque
                        voluptatibus consectetur soluta perspiciatis!</p>
                    <a href="./macro.php"><button class="btn btn-secondary btn-sm btn-outline-dark"
                            type="button">Show More
                        </button></a>
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-sm-6 mb-2">
                    <h4>Sky Photography</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellendus perspiciatis at et minima
                        placeat ducimus in, eveniet blanditiis maxime nisi nam fuga dolor molestias quo tempore
                        praesentium laudantium aspernatur odit, voluptatibus reprehenderit qui sint inventore! Cumque
                        voluptatibus consectetur soluta perspiciatis!</p>
                    <a href="./sky.php"><button class="btn btn-secondary btn-sm btn-outline-dark"
                            type="button">Show More
                        </button></a>
                </div>
                <div class="col-sm-6">
                    <h4>Flower Photography</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellendus perspiciatis at et minima
                        placeat ducimus in, eveniet blanditiis maxime nisi nam fuga dolor molestias quo tempore
                        praesentium laudantium aspernatur odit, voluptatibus reprehenderit qui sint inventore! Cumque
                        voluptatibus consectetur soluta perspiciatis!</p>
                    <a href="./flower.php"><button class="btn btn-secondary btn-sm btn-outline-dark"
                            type="button">Show More
                        </button></a>
                </div>
            </div>
            <div class="row mt-3 mb-3">
                <div class="col-sm-6 mb-2">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellendus perspiciatis at et minima
                        ...
                        praesentium laudantium aspernatur odit, voluptatibus reprehenderit qui sint inventore! Cumque
                        voluptatibus consectetur soluta perspiciatis!</p>
                    <a href="./architecture.php"><button
                            class="btn btn-secondary btn-sm btn-outline-dark" type="button">Show More
                        </button></a>
                </div>
                <div class="col-sm-6">
                    <h4>Sky Photography</h4>
