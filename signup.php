                            ...
                            <div class="card-body p-md-5">
                                <div class="row justify-content-center">
                                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                        ...
                                        <form class="font-weight-bold was-validated mx-1 mx-md-4" action="./data_insert.php"
                                            method="POST">
                                            <div class="form-group">
                                                <label for="UserName">User Name</label>
                                                <input type="text" class="form-control" id="userNameid" name="userName"
                                                    placeholder="Ex : Jos Buttler" onblur="nameValidation()" required>
                                                <div id="userNameErrorMsgid" name="userNameErrorMsg"></div>
                                            </div>
                                            <div class="form-group">
                                                <label for="Email">Email</label>
                                                <input type="email" class="form-control" id="emailid" name="email"
                                                    placeholder="Ex : josbuttler01@gmail.com" onblur="emailValidation()"
                                                    required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" id="conPasswordid"
                                                    placeholder="Confirm your password"
                                                    onblur="confirmPasswordValidation()" required>
